  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 text-sm font-medium">
        <MetricItem label="Slow Queries" value="12" tooltip="Top 12 slowest queries analyzed" />
        <span className="text-text-muted">/</span>
        <MetricItem label="Cache Hit Rate" value="85%" tooltip="Percentage of queries served from cache" />
        <span className="text-text-muted">/</span>
        <MetricItem label="Avg. Rows Per Call" value="1,240" tooltip="Average number of rows processed per call" />
      </div>
