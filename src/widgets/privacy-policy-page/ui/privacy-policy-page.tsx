  ...
  return (
    <div className="min-h-screen bg-bg-main flex flex-col">
      ...
      <div className="bg-bg-card border-b border-border-subtle px-6 text-center py-20">
        ...
        <p className="text-[0.85rem] text-text-muted">Effective date: July 9, 2026</p>
      </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-[820px] mx-auto">
          <p className="text-[0.92rem] text-text-muted leading-[1.75] mb-12">
            ...
            protects personal information when you use Ucode, including Google Calendar and Instagram Direct
            integrations.
          </p>
          ...
          <div id="contact-us" className="mb-4 scroll-mt-24">
            <h2 className="text-[1.15rem] font-bold text-text-main mb-4">10. Contact Us</h2>
