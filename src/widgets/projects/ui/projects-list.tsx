        ...
        {projects.map(project => (
          ...
          >
            <div className="grid w-full grid-cols-[140px_1fr] sm:grid-cols-[140px_1fr_150px_250px] items-center gap-4 px-2">
              {/* Image col */}
              <div className="aspect-[16/9] w-full max-w-[140px] overflow-hidden rounded-xl border border-border-subtle bg-bg-sidebar flex items-center justify-center">
                {project.image ? (
              ...
              <div className="flex flex-col min-w-0 pr-4">
                <h3 className="truncate text-[15px] font-medium text-text-main flex items-center gap-2">
                  {project.name}
                </h3>
              ...
              <div className="hidden sm:flex items-center justify-between">
                ...
                <div className="flex shrink-0 items-center gap-2 opacity-0 transition-opacity group-hover:opacity-100 pr-2">
                  <button
                    className="flex h-8 w-8 items-center justify-center rounded-full text-text-muted hover:text-text-main transition-colors"
